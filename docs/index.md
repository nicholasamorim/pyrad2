...
| Authentication methods | PAP, CHAP, EAP-MD5, EAP-GTC, EAP-TLS, PEAPv0, EAP-TTLS (PAP inner) out of the box; MS-CHAPv2 + EAP-MSCHAPv2 via `pip install pyrad2[mschap]` - see [Authentication Methods](auth.md) |
